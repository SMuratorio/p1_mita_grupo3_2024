...
def actualizar_matriz_peliculas(matriz_peliculas):
    ...
    while opcion_seleccionada == 's':
        ...
        dic_pelicula_actualizar = validar_y_actualizar_pelicula(opcion_actualizar,dic_pelicula_actualizar, id_pelicula)
...
def validar_y_actualizar_pelicula(opcion_actualizar, dic_pelicula_actualizar, id_pelicula):
    validadores = {"Titulo": modulo_validar.validar_titulo, 
